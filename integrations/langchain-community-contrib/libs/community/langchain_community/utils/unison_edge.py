"""Phase 2 edge headers — lineage, auction premium, affiliate, callback."""
...
def extract_response_metadata(headers: requests.structures.CaseInsensitiveDict[str]) -> dict[str, Any]:
    return {
