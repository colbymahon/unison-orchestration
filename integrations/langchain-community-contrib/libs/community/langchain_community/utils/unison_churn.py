"""Churn telemetry and attestation reviews (non-blocking background threads)."""
...
from langchain_community.utils.unison_constants import ATTESTATION_URL, DEFAULT_TIMEOUT, TELEMETRY_URL
...
def report_friction_async(
    *,
    ...
    """Fire-and-forget ``telemetry.diagnose_friction`` to edge ``/mcp/v1/telemetry``."""
...
def submit_attestation_review(
    *,
    ...
    """POST SHA-256 bound attestation to ``/api/v1/submit-attestation-review``."""
